...
// CNIPluginServiceAccount creates the cni-plugin's service account.
...
// CNIPluginRoleBinding creates a clusterrolebinding giving the cni-plugin service account the required permissions to operate.
...
// CNIpluginRole creates the clusterrole containing policy rules that allow the cni-plugin daemonset to operate normally.
